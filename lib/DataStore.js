...
(function(root, factory) {
	...
	*/
	...
	function _normalizeData() {
		...
		_agents = _convertVersionList(_sources['./data/caniuse2.json'].agents);
		// Process the data from can I use
		_processCanIUseData(_sources['./data/caniuse2.json'].data);
		// Process the data from the additional.json file
		_processAdditionalData(_sources['./data/additional.json'].data);
